(function(jsGrid) {
    ...
    jsGrid.locales.fr = {
        grid: {
            ...
            pagePrevText: "<i class='fa fa-step-backward'></i>",
            pageNextText: "<i class='fa fa-step-forward'></i>",
            pageFirstText: "<i class='fa fa-fast-backward'></i>",
            pageLastText: "<i class='fa fa-fast-forward'></i>",
